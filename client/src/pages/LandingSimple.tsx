...
import { Brain, Play, CheckCircle, Users, Clock, Zap, Globe } from 'lucide-react';
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-gray-900 to-black">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-4xl mx-auto">
            ...
            uma inteligência capaz de ser o seu maior e talvez ÚNICO aliado para vender milhões!
          </p>
